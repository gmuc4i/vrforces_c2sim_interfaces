		...
		namespace vrlj
		{
			namespace Connect
			{
				...
				void setup_VR_Forces()
				{
					...
					*/
					DtExerciseConnInitializer* exConn = new  DtExerciseConnInitializer();
					//DtVrlApplicationInitializer* initializer=new DtVrlApplicationInitializer();
					exConn->setDisVersionToSend(7);
